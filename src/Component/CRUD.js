...
function CRUD() {
    ...
    return (
        <Container>
            <div>
                <h2 className="m-3">CRUD FORM</h2>
                <form method="post" onSubmit={(e) => getsubmitdata(e)}>
                    <Table border={2} striped bordered hover style={{ width: "100%", margin: "0 auto" }}>
                        <tbody>
                            <tr>
                ...
                <Table border={2} striped bordered hover style={{ margin: "0 auto" }}>
                    <tbody>
                        <tr>
                            ...
                            <th style={{ background: "#000000", color: "white" }}>Image</th>
                            <th style={{ background: "#000000", color: "white" }}>Name</th>
                            <th style={{ background: "#000000", color: "white" }}>Email</th>
                            <th style={{ background: "#000000", color: "white" }}>Phone</th>
                            <th style={{ background: "#000000", color: "white" }}>Action</th>
                        </tr>
                        {currentPosts.map((v, i) => {
                            return (
                                <tr style={{ verticalAlign: "middle" }} key={v.id}>
                                    ...
                                    <td>{v.phone}</td>
                                    <td>
                                        <button onClick={() => getupdatedata(v.id)} className="btn text-success p-2 fs-5"><FaEdit /></button>
